...
class Plugin(BasePlugin):
    ...
    def create_source_config(self, target_config: TargetConfig) -> SourceConfig:
        meta = {"table": target_config.relation.identifier}
        source_config = SourceConfig(
            name=target_config.relation.get("name", ""),
            identifier=target_config.relation.get("identifier", ""),
            schema=target_config.relation.get("schema", ""),
            database=target_config.relation.get("database", ""),
            meta=meta,
            tags=[],
        )
