...
class DuckDBCredentials(Credentials):
    ...
    # identify whether to use the default credential provider chain for AWS/Gcloud instead of statically defined environment variables
    use_credential_provider: str = ""
